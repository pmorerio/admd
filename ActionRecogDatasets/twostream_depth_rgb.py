...
s1_depth_ckpt = './checkpoint/ntu/s1_train_depth_bott_01012018_010101__dset_ntu_eval_mode_cross_view/model.ckpt'
    ...
    with tf.device(args.gpu0):
        with slim.arg_scope(resnet_v1.resnet_arg_scope()):
            ...
            net_depth_out, endpoints_depth = resnet_v1.resnet_one_stream_main(
                images_depth, nr_frames, num_classes=n_classes, scope='resnet_v1_50_depth', gpu_id=args.gpu0, is_training=is_training, bottleneck=True)
