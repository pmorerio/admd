...
imagenet_ckpt = './resnet_v1_50.ckpt'
uwa3dii_dir = '/datasets/uwa3dii/tfrecords/'
...
def get_temporal_order_onehot(batch_sz, time):
    v = tf.range(time)
    v2 = tf.one_hot(v, time)
    v3 = tf.tile(v2, [batch_sz, 1])
    return v3
