...
flags = tf.app.flags
flags.DEFINE_string('mode', 'None', "'train_rgb', 'train_depth', 'train_double_stream','train_double_stream_moddrop', 'train_hallucination', , 'train_hallucination_p2', 'finetune_hallucination',  'test_hallucination'")
...
def main(_):
    ...
    solver = Solver(model, batch_size=int(FLAGS.bs), train_iter=int(FLAGS.it), train_iter_adv=int(FLAGS.it))
